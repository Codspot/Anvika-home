...
show_usage() {
    cat << EOF
clawlog - Anvika Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View Anvika logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    Anvika logs flow through the macOS unified log (subsystem: ai.anvika).
