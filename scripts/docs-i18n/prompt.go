...
- Keep product names in English: Anvika, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the Anvika Gateway, use “Gateway 网关”.
