...
# Output:
# - dist/Anvika.app
# - dist/Anvika-<version>.zip
# - dist/Anvika-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.anvika.mac}"

"$ROOT_DIR/scripts/package-mac-app.sh"

APP="$ROOT_DIR/dist/Anvika.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/Anvika-$VERSION.zip"
DMG="$ROOT_DIR/dist/Anvika-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/Anvika-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/Anvika-$VERSION.dSYM.zip"
