...
function mergeIMessageAccountConfig(cfg: AnvikaConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: AnvikaConfig): ResolvedIMessageAccount[] {
