...
const loadAnvikaPluginsMock = vi.fn();

vi.mock("./loader.js", () => ({
  loadAnvikaPlugins: (params: unknown) => loadAnvikaPluginsMock(params),
}));
...
function setRegistry(entries: MockRegistryToolEntry[]) {
  ...
  loadAnvikaPluginsMock.mockReturnValue(registry);
  return registry;
}
...
describe("resolvePluginTools optional tools", () => {
  beforeEach(() => {
    loadAnvikaPluginsMock.mockClear();
  });
