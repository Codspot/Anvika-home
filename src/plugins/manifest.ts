...
export const PLUGIN_MANIFEST_FILENAME = "anvika.plugin.json";
...
// package.json "anvika" metadata (used for onboarding/catalog)
...
export type AnvikaPackageManifest = {
  extensions?: string[];
...
): AnvikaPackageManifest | undefined {
  if (!manifest) {
    return undefined;
  }
