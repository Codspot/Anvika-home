...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @anvika/voice-call -> voice-call).
...
export function discoverAnvikaPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ownershipUid?: number | null;
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".anvika", "extensions")];
