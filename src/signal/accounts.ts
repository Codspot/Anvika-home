...
function mergeSignalAccountConfig(cfg: AnvikaConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: AnvikaConfig): ResolvedSignalAccount[] {
