...
const SANDBOX_EXAMPLES = {
  main: [
    ["anvika sandbox list", "List all sandbox containers."],
    ["anvika sandbox list --browser", "List only browser containers."],
    ["anvika sandbox recreate --all", "Recreate all containers."],
    ["anvika sandbox recreate --session main", "Recreate a specific session."],
    ["anvika sandbox recreate --agent mybot", "Recreate agent containers."],
    ["anvika sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["anvika sandbox list", "List all sandbox containers."],
    ["anvika sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ["anvika sandbox recreate --all", "Recreate all containers."],
    ["anvika sandbox recreate --session main", "Recreate a specific session."],
    ["anvika sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["anvika sandbox recreate --browser --all", "Recreate only browser containers."],
    ["anvika sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["anvika sandbox explain", "Show effective sandbox config."],
    ["anvika sandbox explain --session agent:main:main", "Explain a specific session."],
    ["anvika sandbox explain --agent work", "Explain an agent sandbox."],
    ["anvika sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.anvika.ai/cli/sandbox")}\n`,
    )
    .action(() => {
