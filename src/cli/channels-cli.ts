    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["anvika channels list", "List configured channels and auth profiles."],
          ["anvika channels status --probe", "Run channel status checks and probes."],
          [
            "anvika channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["anvika channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.anvika.ai/cli/channels",
        )}\n`,
    );
