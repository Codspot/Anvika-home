    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["anvika directory self --channel slack", "Show the connected account identity."],
          [
            'anvika directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["anvika directory groups list --channel discord", "List available groups/channels."],
          [
            "anvika directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.anvika.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
