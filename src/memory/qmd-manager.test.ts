...
describe("QmdMemoryManager", () => {
  ...
  let stateDir: string;
  let cfg: AnvikaConfig;
  const agentId = "main";

  async function createManager(params?: { mode?: "full" | "status"; cfg?: AnvikaConfig }) {
  ...
  afterEach(async () => {
    ...
    delete (globalThis as Record<string, unknown>).__anvikaMcporterDaemonStart;
    delete (globalThis as Record<string, unknown>).__anvikaMcporterColdStartWarned;
  });
