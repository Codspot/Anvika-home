...
export function resolveModel(
  ...
  const resolvedAgentDir = agentDir ?? resolveAnvikaAgentDir();
 ...
 * a hint.
 *
 * See: https://github.com/anvika/anvika/issues/17328
 */
const LOCAL_PROVIDER_HINTS: Record<string, string> = {
  ollama:
    "Ollama requires authentication to be registered as a provider. " +
    'Set OLLAMA_API_KEY="ollama-local" (any value works) or run "anvika configure". ' +
    "See: https://docs.anvika.ai/providers/ollama",
  vllm:
    "vLLM requires authentication to be registered as a provider. " +
    'Set VLLM_API_KEY (any value works) or run "anvika configure". ' +
    "See: https://docs.anvika.ai/providers/vllm",
};
