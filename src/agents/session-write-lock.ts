...
const CLEANUP_STATE_KEY = Symbol.for("anvika.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("anvika.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("anvika.sessionWriteLockWatchdogState");
