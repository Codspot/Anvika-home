...
function resolveWatchPaths(workspaceDir: string, config?: AnvikaConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: AnvikaConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: AnvikaConfig }) {
