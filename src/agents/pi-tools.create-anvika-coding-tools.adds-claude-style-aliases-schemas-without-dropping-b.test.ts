...
const defaultTools = createAnvikaCodingTools({ senderIsOwner: true });
...
describe("createAnvikaCodingTools", () => {
  ...
  it("enforces apply_patch availability and canonical names across model/provider constraints", () => {
    ...
    const enabledConfig: AnvikaConfig = {
      tools: {
        exec: {
    ...
    const openAiTools = createAnvikaCodingTools({
    ...
    const anthropicTools = createAnvikaCodingTools({
      config: enabledConfig,
    ...
    const allowModelsConfig: AnvikaConfig = {
      tools: {
        exec: {
    ...
    const allowed = createAnvikaCodingTools({
    ...
    const denied = createAnvikaCodingTools({
      config: allowModelsConfig,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
    ...
    const oauthTools = createAnvikaCodingTools({
      modelProvider: "anthropic",
      modelAuthMode: "oauth",
    });
