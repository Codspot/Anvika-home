...
function asAnvikaConfig(config: Partial<AnvikaConfig>): AnvikaConfig {
  return config as AnvikaConfig;
}

function createToolConfig() {
  return asAnvikaConfig({ agents: { list: [{ id: "main", default: true }] } });
}

function createMemoryGetToolOrThrow(config: AnvikaConfig = createToolConfig()) {
