...
type WebSearchConfig = NonNullable<AnvikaConfig["tools"]>["web"] extends infer Web
...
function resolveSearchConfig(cfg?: AnvikaConfig): WebSearchConfig {
...
function missingSearchKeyPayload(provider: (typeof SEARCH_PROVIDERS)[number]) {
  ...
  return {
    ...
    message: `web_search needs a Brave Search API key. Run \`${formatCliCommand("anvika configure --section web")}\` to store it, or set BRAVE_API_KEY in the Gateway environment.`,
    docs: "https://docs.anvika.ai/tools/web",
  };
}
  ...
  return withTrustedWebSearchEndpoint(
    {
      ...
      init: {
        ...
        headers: {
          ...
          "HTTP-Referer": "https://anvika.ai",
          "X-Title": "Anvika Web Search",
        },
