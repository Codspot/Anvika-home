...
function resolveMemoryToolContext(options: { config?: AnvikaConfig; agentSessionKey?: string }) {
...
function resolveMemoryCitationsMode(cfg: AnvikaConfig): MemoryCitationsMode {
