...
function resolveAdaptiveReadMaxBytes(options?: AnvikaReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createAnvikaReadTool(base, {
...
export function createAnvikaReadTool(
  base: AnyAgentTool,
  options?: AnvikaReadToolOptions,
): AnyAgentTool {
