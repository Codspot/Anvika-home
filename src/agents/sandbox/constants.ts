...
export const DEFAULT_SANDBOX_IMAGE = "anvika-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "anvika-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "anvika-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "anvika-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-28-no-sandbox-env";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "anvika-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "anvika-sandbox-browser";
