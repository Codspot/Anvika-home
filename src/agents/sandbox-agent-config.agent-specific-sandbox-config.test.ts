...
async function resolveContext(config: AnvikaConfig, sessionKey: string, workspaceDir: string) {
...
function createWorkSetupCommandConfig(scope: "agent" | "shared"): AnvikaConfig {
  return {
    agents: {
      defaults: {
        sandbox: {
