...
function resolveAvatarSource(cfg: AnvikaConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: AnvikaConfig, agentId: string): AgentAvatarResolution {
