...
function resolveGatewayPort(cfg: AnvikaConfig, env: NodeJS.ProcessEnv): number {
...
function resolveAuth(cfg: AnvikaConfig, env: NodeJS.ProcessEnv): ResolveAuthResult {
  ...
  const password =
    env.ANVIKA_GATEWAY_PASSWORD?.trim() ||
