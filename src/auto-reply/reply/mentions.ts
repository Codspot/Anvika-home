...
function resolveMentionPatterns(cfg: AnvikaConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: AnvikaConfig | undefined, agentId?: string): RegExp[] {
