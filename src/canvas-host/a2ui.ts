...
export const A2UI_PATH = "/__anvika__/a2ui";

export const CANVAS_HOST_PATH = "/__anvika__/canvas";

export const CANVAS_WS_PATH = "/__anvika__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.anvikaCanvasA2UIAction.postMessage(...)
  // - Android: window.anvikaCanvasA2UIAction.postMessage(...)
  const handlerNames = ["anvikaCanvasA2UIAction"];
  ...
  globalThis.Anvika = globalThis.Anvika ?? {};
  globalThis.Anvika.postMessage = postToNode;
  globalThis.Anvika.sendUserAction = sendUserAction;
  globalThis.anvikaPostMessage = postToNode;
  globalThis.anvikaSendUserAction = sendUserAction;
