...
describe("setupOnboardingShellCompletion", () => {
  it("QuickStart: installs without prompting", async () => {
    ...
    expect(deps.ensureCompletionCacheExists).toHaveBeenCalledWith("anvika");
    expect(deps.installCompletion).toHaveBeenCalledWith("zsh", true, "anvika");
