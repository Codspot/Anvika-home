...
export type RunCronAgentTurnResult = {
   ...
   * messages.  See: https://github.com/anvika/anvika/issues/15692
   */
  delivered?: boolean;
  /**
...
export async function runCronIsolatedAgentTurn(params: {
  ...
  const isFastTestEnv = process.env.ANVIKA_TEST_FAST === "1";
  ...
  // correct per-agent paths (e.g. ~/.anvika/agents/<agentId>/agent/).
  ...
  const cfgWithAgentDefaults: AnvikaConfig = {
    ...params.cfg,
