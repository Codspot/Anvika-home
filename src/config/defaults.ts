...
function resolveAnthropicDefaultAuthMode(cfg: AnvikaConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: AnvikaConfig): AnvikaConfig {
...
export function applyTalkApiKey(config: AnvikaConfig): AnvikaConfig {
...
export function applyTalkConfigNormalization(config: AnvikaConfig): AnvikaConfig {
  return normalizeTalkConfig(config);
}

export function applyModelDefaults(cfg: AnvikaConfig): AnvikaConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: AnvikaConfig): AnvikaConfig {
...
export function applyLoggingDefaults(cfg: AnvikaConfig): AnvikaConfig {
...
export function applyContextPruningDefaults(cfg: AnvikaConfig): AnvikaConfig {
...
export function applyCompactionDefaults(cfg: AnvikaConfig): AnvikaConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
