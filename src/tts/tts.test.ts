...
describe("tts", () => {
  ...
  describe("maybeApplyTtsToPayload", () => {
    ...
    const withMockedAutoTtsFetch = async (
      ...
      const prevPrefs = process.env.ANVIKA_TTS_PREFS;
      process.env.ANVIKA_TTS_PREFS = `/tmp/tts-test-${Date.now()}.json`;
      ...
      try {
        ...
        process.env.ANVIKA_TTS_PREFS = prevPrefs;
      }
    };

    const taggedCfg: AnvikaConfig = {
      ...baseCfg,
      messages: {
        ...baseCfg.messages!,
