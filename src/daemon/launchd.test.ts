...
describe("launchctl list detection", () => {
  it("detects the resolved label in launchctl list", async () => {
    state.listOutput = "123 0 ai.anvika.gateway\n";
    const listed = await isLaunchAgentListed({
      env: { HOME: "/Users/test", ANVIKA_PROFILE: "default" },
    });
...
describe("launchd install", () => {
  ...
  it("shows actionable guidance when launchctl gui domain does not support bootstrap", async () => {
    ...
    expect(message).toContain("https://docs.anvika.ai/gateway");
  });
...
describe("resolveLaunchAgentPlistPath", () => {
  it.each([
    {
      name: "uses default label when ANVIKA_PROFILE is unset",
      env: { HOME: "/Users/test" },
      expected: "/Users/test/Library/LaunchAgents/ai.anvika.gateway.plist",
    },
    {
      name: "uses profile-specific label when ANVIKA_PROFILE is set to a custom value",
      env: { HOME: "/Users/test", ANVIKA_PROFILE: "jbphoenix" },
      expected: "/Users/test/Library/LaunchAgents/ai.anvika.jbphoenix.plist",
    },
    {
      name: "prefers ANVIKA_LAUNCHD_LABEL over ANVIKA_PROFILE",
      env: {
        HOME: "/Users/test",
        ANVIKA_PROFILE: "jbphoenix",
        ANVIKA_LAUNCHD_LABEL: "com.custom.label",
      },
      expected: "/Users/test/Library/LaunchAgents/com.custom.label.plist",
    },
    {
      name: "trims whitespace from ANVIKA_LAUNCHD_LABEL",
      env: {
        HOME: "/Users/test",
        ANVIKA_LAUNCHD_LABEL: "  com.custom.label  ",
      },
    ...
    {
      name: "ignores empty ANVIKA_LAUNCHD_LABEL and falls back to profile",
      env: {
        HOME: "/Users/test",
        ANVIKA_PROFILE: "myprofile",
        ANVIKA_LAUNCHD_LABEL: "   ",
      },
      expected: "/Users/test/Library/LaunchAgents/ai.anvika.myprofile.plist",
    },
  ])("$name", ({ env, expected }) => {
