...
import { type AnvikaConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: AnvikaConfig): string[] {
...
export function listAgentsForGateway(cfg: AnvikaConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: AnvikaConfig): string {
...
function resolveSessionStoreAgentId(cfg: AnvikaConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: AnvikaConfig): {
  storePath: string;
  store: Record<string, SessionEntry>;
} {
...
export function getSessionDefaults(cfg: AnvikaConfig): GatewaySessionsDefaults {
