...
const ensureAnvikaModelsJson = vi.fn().mockResolvedValue(undefined);
const resolveAnvikaAgentDir = vi.fn().mockReturnValue("/tmp/anvika-agent");
...
vi.mock("../config/config.js", () => ({
  ...
  STATE_DIR: "/tmp/anvika-state",
  loadConfig,
}));

vi.mock("../agents/models-config.js", () => ({
  ensureAnvikaModelsJson,
}));

vi.mock("../agents/agent-paths.js", () => ({
  resolveAnvikaAgentDir,
}));
