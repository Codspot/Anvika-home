...
export function applyVercelAiGatewayProviderConfig(cfg: AnvikaConfig): AnvikaConfig {
...
export function applyVercelAiGatewayConfig(cfg: AnvikaConfig): AnvikaConfig {
