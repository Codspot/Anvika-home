...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.anvika.ai/automation/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("anvika hooks list")}`,
      `  ${formatCliCommand("anvika hooks enable <name>")}`,
      `  ${formatCliCommand("anvika hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
