...
export function applyOpenrouterProviderConfig(cfg: AnvikaConfig): AnvikaConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyOpenrouterConfig(cfg: AnvikaConfig): AnvikaConfig {
  const next = applyOpenrouterProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, OPENROUTER_DEFAULT_MODEL_REF);
}

export function applyMoonshotProviderConfig(cfg: AnvikaConfig): AnvikaConfig {
  return applyMoonshotProviderConfigWithBaseUrl(cfg, MOONSHOT_BASE_URL);
}

export function applyMoonshotProviderConfigCn(cfg: AnvikaConfig): AnvikaConfig {
...
export function applyMoonshotConfig(cfg: AnvikaConfig): AnvikaConfig {
  const next = applyMoonshotProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyMoonshotConfigCn(cfg: AnvikaConfig): AnvikaConfig {
  const next = applyMoonshotProviderConfigCn(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyKimiCodeProviderConfig(cfg: AnvikaConfig): AnvikaConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: AnvikaConfig): AnvikaConfig {
  const next = applyKimiCodeProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, KIMI_CODING_MODEL_REF);
}

export function applySyntheticProviderConfig(cfg: AnvikaConfig): AnvikaConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: AnvikaConfig): AnvikaConfig {
  const next = applySyntheticProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, SYNTHETIC_DEFAULT_MODEL_REF);
}

export function applyXiaomiProviderConfig(cfg: AnvikaConfig): AnvikaConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: AnvikaConfig): AnvikaConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: AnvikaConfig): AnvikaConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: AnvikaConfig): AnvikaConfig {
 ...
 */
export function applyTogetherProviderConfig(cfg: AnvikaConfig): AnvikaConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyTogetherConfig(cfg: AnvikaConfig): AnvikaConfig {
 ...
 */
export function applyHuggingfaceProviderConfig(cfg: AnvikaConfig): AnvikaConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyHuggingfaceConfig(cfg: AnvikaConfig): AnvikaConfig {
  const next = applyHuggingfaceProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, HUGGINGFACE_DEFAULT_MODEL_REF);
}

export function applyXaiProviderConfig(cfg: AnvikaConfig): AnvikaConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXaiConfig(cfg: AnvikaConfig): AnvikaConfig {
  const next = applyXaiProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, XAI_DEFAULT_MODEL_REF);
}

export function applyMistralProviderConfig(cfg: AnvikaConfig): AnvikaConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyMistralConfig(cfg: AnvikaConfig): AnvikaConfig {
 ...
 */
export function applyKilocodeProviderConfig(cfg: AnvikaConfig): AnvikaConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyKilocodeConfig(cfg: AnvikaConfig): AnvikaConfig {
...
export function applyQianfanProviderConfig(cfg: AnvikaConfig): AnvikaConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyQianfanConfig(cfg: AnvikaConfig): AnvikaConfig {
