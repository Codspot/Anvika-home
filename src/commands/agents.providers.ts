...
function resolveDefaultAccountId(cfg: AnvikaConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: AnvikaConfig): boolean {
...
export function summarizeBindings(cfg: AnvikaConfig, bindings: AgentBinding[]): string[] {
