...
export function listChannelMessageActions(cfg: AnvikaConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: AnvikaConfig): boolean {
...
export function supportsChannelMessageCards(cfg: AnvikaConfig): boolean {
