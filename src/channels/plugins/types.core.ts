...
export type ChannelAgentToolFactory = (params: { cfg?: AnvikaConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: AnvikaConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: AnvikaConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: AnvikaConfig }) => boolean;
  supportsCards?: (params: { cfg: AnvikaConfig }) => boolean;
