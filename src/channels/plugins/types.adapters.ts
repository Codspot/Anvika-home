...
export type ChannelConfigAdapter<ResolvedAccount> = {
  ...
  resolveAccount: (cfg: AnvikaConfig, accountId?: string | null) => ResolvedAccount;
  defaultAccountId?: (cfg: AnvikaConfig) => string;
  setAccountEnabled?: (params: {
    cfg: AnvikaConfig;
    accountId: string;
    enabled: boolean;
  }) => AnvikaConfig;
  deleteAccount?: (params: { cfg: AnvikaConfig; accountId: string }) => AnvikaConfig;
  isEnabled?: (account: ResolvedAccount, cfg: AnvikaConfig) => boolean;
  disabledReason?: (account: ResolvedAccount, cfg: AnvikaConfig) => string;
  isConfigured?: (account: ResolvedAccount, cfg: AnvikaConfig) => boolean | Promise<boolean>;
  unconfiguredReason?: (account: ResolvedAccount, cfg: AnvikaConfig) => string;
  describeAccount?: (account: ResolvedAccount, cfg: AnvikaConfig) => ChannelAccountSnapshot;
...
export type ChannelHeartbeatAdapter = {
  ...
  resolveRecipients?: (params: { cfg: AnvikaConfig; opts?: { to?: string; all?: boolean } }) => {
    recipients: string[];
    source: string;
  };
};
