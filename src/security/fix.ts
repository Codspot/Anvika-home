...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof AnvikaConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: AnvikaConfig; env: NodeJS.ProcessEnv }): {
  cfg: AnvikaConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
