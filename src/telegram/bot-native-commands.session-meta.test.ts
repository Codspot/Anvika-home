...
function registerAndResolveStatusHandler(cfg: AnvikaConfig): TelegramCommandHandler {
...
describe("registerTelegramNativeCommands — session metadata", () => {
  beforeEach(() => {
    ...
    sessionMocks.resolveStorePath.mockClear().mockReturnValue("/tmp/anvika-sessions.json");
