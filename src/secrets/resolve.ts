...
function resolveResolutionLimits(config: AnvikaConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: AnvikaConfig): SecretProviderConfig {
