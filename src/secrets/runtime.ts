...
type SecretDefaults = NonNullable<AnvikaConfig["secrets"]>["defaults"];
...
function collectCandidateAgentDirs(config: AnvikaConfig): string[] {
  const dirs = new Set<string>();
  dirs.add(resolveUserPath(resolveAnvikaAgentDir()));
