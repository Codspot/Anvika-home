...
export class AcpSessionManager {
  ...
  resolveSession(params: { cfg: AnvikaConfig; sessionKey: string }): AcpSessionResolution {
  ...
  getObservabilitySnapshot(cfg: AnvikaConfig): AcpManagerObservabilitySnapshot {
  ...
  private enforceConcurrentSessionLimit(params: { cfg: AnvikaConfig; sessionKey: string }): void {
  ...
  private async evictIdleRuntimeHandles(params: { cfg: AnvikaConfig }): Promise<void> {
