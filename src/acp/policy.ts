...
export function isAcpEnabledByPolicy(cfg: AnvikaConfig): boolean {
  return cfg.acp?.enabled !== false;
}

export function resolveAcpDispatchPolicyState(cfg: AnvikaConfig): AcpDispatchPolicyState {
...
export function isAcpDispatchEnabledByPolicy(cfg: AnvikaConfig): boolean {
  return resolveAcpDispatchPolicyState(cfg) === "enabled";
}

export function resolveAcpDispatchPolicyMessage(cfg: AnvikaConfig): string | null {
...
export function resolveAcpDispatchPolicyError(cfg: AnvikaConfig): AcpRuntimeError | null {
...
export function isAcpAgentAllowedByPolicy(cfg: AnvikaConfig, agentId: string): boolean {
