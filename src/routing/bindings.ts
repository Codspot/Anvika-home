...
export function listBindings(cfg: AnvikaConfig): AgentBinding[] {
...
export function listBoundAccountIds(cfg: AnvikaConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: AnvikaConfig) {
