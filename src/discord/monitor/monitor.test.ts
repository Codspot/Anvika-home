...
describe("agent components", () => {
  const createCfg = (): AnvikaConfig => ({}) as AnvikaConfig;
...
describe("discord component interactions", () => {
  ...
  beforeEach(() => {
    ...
    resolveStorePathMock.mockClear().mockReturnValue("/tmp/anvika-sessions-test.json");
  });
