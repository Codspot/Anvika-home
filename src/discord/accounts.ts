...
function mergeDiscordAccountConfig(cfg: AnvikaConfig, accountId: string): DiscordAccountConfig {
...
export function listEnabledDiscordAccounts(cfg: AnvikaConfig): ResolvedDiscordAccount[] {
