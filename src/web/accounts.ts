...
export function listWhatsAppAuthDirs(cfg: AnvikaConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: AnvikaConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: AnvikaConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: AnvikaConfig): ResolvedWhatsAppAccount[] {
