...
function mergeSlackAccountConfig(cfg: AnvikaConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: AnvikaConfig): ResolvedSlackAccount[] {
