...
// Prefix for Anvika-generated action IDs to scope our handler
const ANVIKA_ACTION_PREFIX = "anvika:";
...
export function registerSlackInteractionEvents(params: { ctx: SlackMonitorContext }) {
  ...
  const modalMatcher = new RegExp(`^${ANVIKA_ACTION_PREFIX}`);

  // Handle Anvika modal submissions with callback_ids scoped by our prefix.
