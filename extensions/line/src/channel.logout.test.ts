import type { AnvikaConfig, PluginRuntime, ResolvedLineAccount } from "anvika/plugin-sdk";
...
function createRuntime(): { runtime: PluginRuntime; mocks: LineRuntimeMocks } {
  ...
  const resolveLineAccount = vi.fn(
    ({ cfg, accountId }: { cfg: AnvikaConfig; accountId?: string }) => {
...
async function runLogoutScenario(params: { cfg: AnvikaConfig; accountId: string }): Promise<{
