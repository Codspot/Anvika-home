...
export function listGoogleChatAccountIds(cfg: AnvikaConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: AnvikaConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: AnvikaConfig): ResolvedGoogleChatAccount[] {
