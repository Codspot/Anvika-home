...
import type { ReplyPayload, AnvikaConfig } from "anvika/plugin-sdk";
import { createReplyPrefixOptions } from "anvika/plugin-sdk";
...
async function processTwitchMessage(params: {
  ...
  const cfg = config as AnvikaConfig;
