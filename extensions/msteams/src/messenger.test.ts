...
import { SILENT_REPLY_TOKEN, type PluginRuntime } from "anvika/plugin-sdk";
...
import { resolvePreferredAnvikaTmpDir } from "../../../src/infra/tmp-anvika-dir.js";
import {
  type MSTeamsAdapter,
...
describe("msteams messenger", () => {
  ...
  describe("sendMSTeamsMessages", () => {
    ...
    it("preserves parsed mentions when appending OneDrive fallback file links", async () => {
      const tmpDir = await mkdtemp(path.join(resolvePreferredAnvikaTmpDir(), "msteams-mention-"));
