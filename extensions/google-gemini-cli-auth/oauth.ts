...
import { fetchWithSsrFGuard, isWSL2Sync } from "anvika/plugin-sdk";

const CLIENT_ID_KEYS = ["ANVIKA_GEMINI_OAUTH_CLIENT_ID", "GEMINI_CLI_OAUTH_CLIENT_ID"];
      ...
      try {
        ...
        res.end(
          "<!doctype html><html><head><meta charset='utf-8'/></head>" +
            ...
            "<p>You can close this window and return to Anvika.</p></body></html>",
        );
