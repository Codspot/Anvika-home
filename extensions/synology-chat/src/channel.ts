/**
 * Synology Chat Channel Plugin for Anvika.
 *
...
export function createSynologyChatPlugin() {
  return {
    ...
    meta: {
      ...
      blurb: "Connect your Synology NAS Chat to Anvika",
      order: 90,
    },
    ...
    pairing: {
      ...
      notifyApproval: async ({ cfg, id }: { cfg: any; id: string }) => {
        ...
        await sendMessage(
          account.incomingUrl,
          "Anvika: your access has been approved.",
          id,
    ...
    security: {
      resolveDmPolicy: ({
        ...
        return {
          ...
          approveHint: "anvika pairing approve synology-chat <code>",
