...
This directory contains the **BlueBubbles external channel plugin** for Anvika.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `anvika/plugin-sdk` helpers.
