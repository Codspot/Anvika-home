...
import { resolveChannelMediaMaxBytes, type AnvikaConfig } from "anvika/plugin-sdk";
...
function resolveMediaLocalRoots(params: { cfg: AnvikaConfig; accountId?: string }): string[] {
