...
export function listBlueBubblesAccountIds(cfg: AnvikaConfig): string[] {
...
export function resolveDefaultBlueBubblesAccountId(cfg: AnvikaConfig): string {
...
export function listEnabledBlueBubblesAccounts(cfg: AnvikaConfig): ResolvedBlueBubblesAccount[] {
