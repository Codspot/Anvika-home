import type { ChannelOnboardingAdapter, AnvikaConfig, WizardPrompter } from "anvika/plugin-sdk";
...
async function noteMattermostSetup(prompter: WizardPrompter): Promise<void> {
  await prompter.note(
    [
      ...
      "Docs: https://docs.anvika.ai/channels/mattermost",
    ].join("\n"),
