...
export function listMattermostAccountIds(cfg: AnvikaConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: AnvikaConfig): string {
...
export function listEnabledMattermostAccounts(cfg: AnvikaConfig): ResolvedMattermostAccount[] {
