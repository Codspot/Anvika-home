...
export function listZalouserAccountIds(cfg: AnvikaConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: AnvikaConfig): string {
...
function mergeZalouserAccountConfig(cfg: AnvikaConfig, accountId: string): ZalouserAccountConfig {
