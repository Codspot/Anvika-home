---
summary: "Use NVIDIA's OpenAI-compatible API in Anvika"
read_when:
  - You want to use NVIDIA models in Anvika
...
anvika onboard --auth-choice skip
anvika models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
