---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with Anvika"
read_when:
  - You want Xiaomi MiMo models in Anvika
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). Anvika uses
