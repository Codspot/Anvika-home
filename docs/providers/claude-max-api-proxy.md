...
You can point Anvika at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Anvika
...
- [Anthropic provider](/providers/anthropic) - Native Anvika integration with Claude setup-token or API keys
