...
Deepgram is a speech-to-text API. In Anvika it is used for **inbound audio/voice note
transcription** via `tools.media.audio`.

When enabled, Anvika uploads the audio file to Deepgram and injects the transcript
