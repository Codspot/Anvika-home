---
summary: "Use Qwen OAuth (free tier) in Anvika"
read_when:
  - You want to use Qwen with Anvika
...
If you already logged in with the Qwen Code CLI, Anvika will sync credentials
