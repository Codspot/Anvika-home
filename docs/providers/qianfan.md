---
summary: "Use Qianfan's unified API to access many models in Anvika"
read_when:
...
3. Anvika installed on your system
...
4. Copy the API key for use with Anvika

## CLI setup

```bash
anvika onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [Anvika Configuration](/gateway/configuration)
