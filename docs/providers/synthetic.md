---
summary: "Use Synthetic's Anthropic-compatible API in Anvika"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. Anvika registers it as the
...
Note: Anvika's Anthropic client appends `/v1` to the base URL, so use
