...
read_when:
  - You are building a Anvika plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (anvika.plugin.json)

Every plugin **must** ship a `anvika.plugin.json` file in the **plugin root**.
Anvika uses this manifest to validate configuration **without executing plugin
