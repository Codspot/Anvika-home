...
Anvika ships three update channels:
...
When you **explicitly** switch channels with `--channel`, Anvika also aligns
the install method:
...
When you switch channels with `anvika update`, Anvika also syncs plugin sources:
