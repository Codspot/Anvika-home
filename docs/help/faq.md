---
summary: "Frequently asked questions about Anvika setup, configuration, and usage"
read_when:
...
- [Quick start and first-run setup]
  ...
  - [What's the recommended way to install and set up Anvika?](#whats-the-recommended-way-to-install-and-set-up-anvika)
  ...
  - [I can't access docs.anvika.ai (SSL error). What now?](#i-cant-access-docsanvikaai-ssl-error-what-now)
  - [What's the difference between stable and beta?](#whats-the-difference-between-stable-and-beta)
  - [How do I install the beta version, and what's the difference between beta and dev?](#how-do-i-install-the-beta-version-and-whats-the-difference-between-beta-and-dev)
  - [How do I try the latest bits?](#how-do-i-try-the-latest-bits)
  - [How long does install and onboarding usually take?](#how-long-does-install-and-onboarding-usually-take)
  - [Installer stuck? How do I get more feedback?](#installer-stuck-how-do-i-get-more-feedback)
  - [Windows install says git not found or anvika not recognized](#windows-install-says-git-not-found-or-anvika-not-recognized)
  - [The docs didn't answer my question - how do I get a better answer?](#the-docs-didnt-answer-my-question-how-do-i-get-a-better-answer)
  - [How do I install Anvika on Linux?](#how-do-i-install-anvika-on-linux)
  - [How do I install Anvika on a VPS?](#how-do-i-install-anvika-on-a-vps)
  - [Where are the cloud/VPS install guides?](#where-are-the-cloudvps-install-guides)
  - [Can I ask Anvika to update itself?](#can-i-ask-anvika-to-update-itself)
  ...
  - [If I buy a Mac mini to run Anvika, can I connect it to my MacBook Pro?](#if-i-buy-a-mac-mini-to-run-anvika-can-i-connect-it-to-my-macbook-pro)
  - [Can I use Bun?](#can-i-use-bun)
  - [Telegram: what goes in `allowFrom`?](#telegram-what-goes-in-allowfrom)
  - [Can multiple people use one WhatsApp number with different Anvika instances?](#can-multiple-people-use-one-whatsapp-number-with-different-anvika-instances)
  - [Can I run a "fast chat" agent and an "Opus for coding" agent?](#can-i-run-a-fast-chat-agent-and-an-opus-for-coding-agent)
  - [Does Homebrew work on Linux?](#does-homebrew-work-on-linux)
  - [What's the difference between the hackable (git) install and npm install?](#whats-the-difference-between-the-hackable-git-install-and-npm-install)
  - [Can I switch between npm and git installs later?](#can-i-switch-between-npm-and-git-installs-later)
  - [Should I run the Gateway on my laptop or a VPS?](#should-i-run-the-gateway-on-my-laptop-or-a-vps)
  - [How important is it to run Anvika on a dedicated machine?](#how-important-is-it-to-run-anvika-on-a-dedicated-machine)
  - [What are the minimum VPS requirements and recommended OS?](#what-are-the-minimum-vps-requirements-and-recommended-os)
  - [Can I run Anvika in a VM and what are the requirements](#can-i-run-anvika-in-a-vm-and-what-are-the-requirements)
- [What is Anvika?](#what-is-anvika)
  - [What is Anvika, in one paragraph?](#what-is-anvika-in-one-paragraph)
  - [What's the value proposition?](#whats-the-value-proposition)
  - [I just set it up what should I do first](#i-just-set-it-up-what-should-i-do-first)
  - [What are the top five everyday use cases for Anvika](#what-are-the-top-five-everyday-use-cases-for-anvika)
  - [Can Anvika help with lead gen outreach ads and blogs for a SaaS](#can-anvika-help-with-lead-gen-outreach-ads-and-blogs-for-a-saas)
...
- [Skills and automation](#skills-and-automation)
  ...
  - [Can Anvika run tasks on a schedule or continuously in the background?](#can-anvika-run-tasks-on-a-schedule-or-continuously-in-the-background)
...
- [Where things live on disk](#where-things-live-on-disk)
  - [Is all data used with Anvika saved locally?](#is-all-data-used-with-anvika-saved-locally)
  - [Where does Anvika store its data?](#where-does-anvika-store-its-data)
  - [Where should AGENTS.md / SOUL.md / USER.md / MEMORY.md live?](#where-should-agentsmd-soulmd-usermd-memorymd-live)
  - [What's the recommended backup strategy?](#whats-the-recommended-backup-strategy)
  - [How do I completely uninstall Anvika?](#how-do-i-completely-uninstall-anvika)
...
- [Config basics](#config-basics)
  ...
  - [Can the Anvika browser run headless?](#can-the-anvika-browser-run-headless)
...
- [Remote gateways and nodes](#remote-gateways-and-nodes)
  ...
  - [Can two Anvika instances talk to each other (local + VPS)?](#can-two-anvika-instances-talk-to-each-other-local-vps)
...
- [Env vars and .env loading](#env-vars-and-env-loading)
  - [How does Anvika load environment variables?](#how-does-anvika-load-environment-variables)
...
- [Sessions and multiple chats](#sessions-and-multiple-chats)
  ...
  - [Is there a way to make a team of Anvika instances one CEO and many agents](#is-there-a-way-to-make-a-team-of-anvika-instances-one-ceo-and-many-agents)
  - [Why did context get truncated mid-task? How do I prevent it?](#why-did-context-get-truncated-midtask-how-do-i-prevent-it)
  - [How do I completely reset Anvika but keep it installed?](#how-do-i-completely-reset-anvika-but-keep-it-installed)
  ...
  - [Why doesn't Anvika reply in a group?](#why-doesnt-anvika-reply-in-a-group)
...
- [Models: defaults, selection, aliases, switching](#models-defaults-selection-aliases-switching)
  ...
  - [What do Anvika, Flawd, and Krill use for models?](#what-do-anvika-flawd-and-krill-use-for-models)
...
- [Gateway: ports, "already running", and remote mode](#gateway-ports-already-running-and-remote-mode)
  ...
  - [Why does `anvika gateway status` say `Runtime: running` but `RPC probe: failed`?](#why-does-anvika-gateway-status-say-runtime-running-but-rpc-probe-failed)
  - [Why does `anvika gateway status` show `Config (cli)` and `Config (service)` different?](#why-does-anvika-gateway-status-show-config-cli-and-config-service-different)
  - [What does "another gateway instance is already listening" mean?](#what-does-another-gateway-instance-is-already-listening-mean)
  - [How do I run Anvika in remote mode (client connects to a Gateway elsewhere)?](#how-do-i-run-anvika-in-remote-mode-client-connects-to-a-gateway-elsewhere)
...
- [Logging and debugging](#logging-and-debugging)
  ...
  - [I closed my terminal on Windows - how do I restart Anvika?](#i-closed-my-terminal-on-windows-how-do-i-restart-anvika)
  ...
  - [ELI5: `anvika gateway restart` vs `anvika gateway`](#eli5-anvika-gateway-restart-vs-anvika-gateway)
  - [What's the fastest way to get more details when something fails?](#whats-the-fastest-way-to-get-more-details-when-something-fails)
- [Media and attachments](#media-and-attachments)
  - [My skill generated an image/PDF, but nothing was sent](#my-skill-generated-an-imagepdf-but-nothing-was-sent)
- [Security and access control](#security-and-access-control)
  - [Is it safe to expose Anvika to inbound DMs?](#is-it-safe-to-expose-anvika-to-inbound-dms)
...
5. **Tail the latest log**
   ...
   ```bash
   tail -f "$(ls -t /tmp/anvika/anvika-*.log | head -1)"
   ```
...
7. **Gateway snapshot**
   ...
   ```bash
   anvika health --json
   anvika health --verbose   # shows the target URL + config path on errors
   ```
...
```bash
curl -fsSL https://anvika.ai/install.sh | bash -s -- --install-method git
```

This installs Anvika **from a git checkout**, so the agent can read the code + docs and
...
[https://github.com/anvika/anvika/issues](https://github.com/anvika/anvika/issues)
[https://github.com/anvika/anvika/pulls](https://github.com/anvika/anvika/pulls)

Start with these commands (share outputs when asking for help):

```bash
anvika status
anvika models status
anvika doctor
```

What they do:

- `anvika status`: quick snapshot of gateway/agent health + basic config.
- `anvika models status`: checks provider auth + model availability.
- `anvika doctor`: validates and repairs common config/state issues.

Other useful CLI checks: `anvika status --all`, `anvika logs --follow`,
`anvika gateway status`, `anvika health --verbose`.

Quick debug loop: [First 60 seconds if something's broken](#first-60-seconds-if-somethings-broken).
Install docs: [Install](/install), [Installer flags](/install/installer), [Updating](/install/updating).

### What's the recommended way to install and set up Anvika

The repo recommends running from source and using the onboarding wizard:

```bash
curl -fsSL https://anvika.ai/install.sh | bash
anvika onboard --install-daemon
```
...
```bash
git clone https://github.com/anvika/anvika.git
cd anvika
pnpm install
pnpm build
...
If you don't have a global install yet, run it via `pnpm anvika onboard`.
...
- If it asks for auth, paste the token from `gateway.auth.token` (or `ANVIKA_GATEWAY_TOKEN`) into Control UI settings.
- Retrieve it from the gateway host: `anvika config get gateway.auth.token` (or generate one: `anvika doctor --generate-gateway-token`).

**Not on localhost:**

- **Tailscale Serve** (recommended): keep bind loopback, run `anvika gateway --tailscale serve`, open `https://<magicdns>/`. If `gateway.auth.allowTailscale` is `true`, identity headers satisfy Control UI/WebSocket auth (no token, assumes trusted gateway host); HTTP APIs still require token/password.
- **Tailnet bind**: run `anvika gateway --bind tailnet --token "<token>"`, open `http://<tailscale-ip>:18789/`, paste token in dashboard settings.
...
1. Install Anvika on the new machine.
2. Copy `$ANVIKA_STATE_DIR` (default: `~/.anvika`) from the old machine.
3. Copy your workspace (default: `~/.anvika/workspace`).
4. Run `anvika doctor` and restart the Gateway service.
...
under `~/.anvika/` (for example `~/.anvika/agents/<agentId>/sessions/`).

Related: [Migrating](/install/migrating), [Where things live on disk](/help/faq#where-does-anvika-store-its-data),
...
[https://github.com/anvika/anvika/blob/main/CHANGELOG.md](https://github.com/anvika/anvika/blob/main/CHANGELOG.md)

Newest entries are at the top. If the top section is marked **Unreleased**, the next dated
section is the latest shipped version. Entries are grouped by **Highlights**, **Changes**, and
**Fixes** (plus docs/other sections when needed).

### I can't access docs.anvika.ai SSL error What now

Some Comcast/Xfinity connections incorrectly block `docs.anvika.ai` via Xfinity
Advanced Security. Disable it or allowlist `docs.anvika.ai`, then retry. More
detail: [Troubleshooting](/help/troubleshooting#docsanvikaai-shows-an-ssl-error-comcastxfinity).
Please help us unblock it by reporting here: [https://spa.xfinity.com/check_url_status](https://spa.xfinity.com/check_url_status).

If you still can't reach the site, the docs are mirrored on GitHub:
[https://github.com/anvika/anvika/tree/main/docs](https://github.com/anvika/anvika/tree/main/docs)
...
```bash
curl -fsSL --proto '=https' --tlsv1.2 https://anvika.ai/install.sh | bash -s -- --beta
```

```bash
curl -fsSL --proto '=https' --tlsv1.2 https://anvika.ai/install.sh | bash -s -- --install-method git
```

Windows installer (PowerShell):
[https://anvika.ai/install.ps1](https://anvika.ai/install.ps1)
...
```bash
curl -fsSL https://anvika.ai/install.sh | bash -s -- --verbose
```

Beta install with verbose:

```bash
curl -fsSL https://anvika.ai/install.sh | bash -s -- --beta --verbose
```

For a hackable (git) install:

```bash
curl -fsSL https://anvika.ai/install.sh | bash -s -- --install-method git --verbose
```
...
Set-PSDebug -Trace 1
& ([scriptblock]::Create((iwr -useb https://anvika.ai/install.ps1))) -NoOnboard
Set-PSDebug -Trace 0
```

More options: [Installer flags](/install/installer).

### Windows install says git not found or anvika not recognized
...
**2) anvika is not recognized after install**
...
### How do I install Anvika on Linux
...
### How do I install Anvika on a VPS
...
### Can I ask Anvika to update itself
...
```bash
anvika update
anvika update status
anvika update --channel stable|beta|dev
anvika update --tag <dist-tag|version>
anvika update --no-restart
```

If you must automate from an agent:

```bash
anvika update --yes --no-restart
anvika gateway restart
```
...
`anvika onboard` is the recommended setup path. In **local mode** it walks you through:
...
No. You can run Anvika with **API keys** (Anthropic/OpenAI/others) or with
...
`claude setup-token` generates a **token string** via the Claude Code CLI (it is not available in the web console). You can run it on **any machine**. Choose **Anthropic token (paste setup-token)** in the wizard or paste it with `anvika models auth paste-token --provider anthropic`. The token is stored as an auth profile for the **anthropic** provider and used like an API key (no auto-refresh). More detail: [OAuth](/concepts/oauth).
...
Copy the token it prints, then choose **Anthropic token (paste setup-token)** in the wizard. If you want to run it on the gateway host, use `anvika models auth setup-token --provider anthropic`. If you ran `claude setup-token` elsewhere, paste it on the gateway host with `anvika models auth paste-token --provider anthropic`. See [Anthropic](/providers/anthropic).

### Do you support Claude subscription auth (Claude Pro or Max)

Yes - via **setup-token**. Anvika no longer reuses Claude Code CLI OAuth tokens; use a setup-token or an Anthropic API key. Generate the token anywhere and paste it on the gateway host. See [Anthropic](/providers/anthropic) and [OAuth](/concepts/oauth).
...
Tip: set a **fallback model** so Anvika can keep replying while a provider is rate-limited.
...
Anvika supports **OpenAI Code (Codex)** via OAuth (ChatGPT sign-in). The wizard can run the OAuth flow and will set the default model to `openai-codex/gpt-5.3-codex` when appropriate. See [Model providers](/concepts/model-providers) and [Wizard](/start/wizard).

### Do you support OpenAI subscription auth Codex OAuth

Yes. Anvika fully supports **OpenAI Code (Codex) subscription OAuth**. The onboarding wizard
...
Gemini CLI uses a **plugin auth flow**, not a client id or secret in `anvika.json`.

Steps:

1. Enable the plugin: `anvika plugins enable google-gemini-cli-auth`
2. Login: `anvika models auth login --provider google-gemini-cli --set-default`

This stores OAuth tokens in auth profiles on the gateway host. Details: [Model providers](/concepts/model-providers).

### Is a local model OK for casual chats

Usually no. Anvika needs large context + strong safety; small cards truncate and leak. If you must, run the **largest** MiniMax M2.1 build you can locally (LM Studio) and see [/gateway/local-models](/gateway/local-models). Smaller/quantized models increase prompt-injection risk - see [Security](/gateway/security).
...
No. Anvika runs on macOS or Linux (Windows via WSL2). A Mac mini is optional - some people
...
### If I buy a Mac mini to run Anvika can I connect it to my MacBook Pro
...
- Use `anvika nodes status` / `anvika nodes list` to see it.
...
The onboarding wizard accepts `@username` input and resolves it to a numeric ID, but Anvika authorization uses numeric IDs only.

Safer (no third-party bot):

- DM your bot, then run `anvika logs --follow` and read `from.id`.
...
### Can multiple people use one WhatsApp number with different Anvika instances
...
If you run Anvika via systemd, ensure the service PATH includes `/home/linuxbrew/.linuxbrew/bin` (or your brew prefix) so `brew`-installed tools resolve in non-login shells.
...
This **does not delete your data** - it only changes the Anvika code install. Your state
(`~/.anvika`) and workspace (`~/.anvika/workspace`) stay untouched.
...
**Anvika-specific note:** WhatsApp/Telegram/Slack/Mattermost (plugin)/Discord all work fine from a VPS. The only real trade-off is **headless browser** vs a visible window. See [Browser](/tools/browser).

**Recommended default:** VPS if you had gateway disconnects before. Local is great when you're actively using the Mac and want local file access or UI automation with a visible browser.

### How important is it to run Anvika on a dedicated machine
...
Anvika is lightweight. For a basic Gateway + one chat channel:
...
### Can I run Anvika in a VM and what are the requirements
...
### What is Anvika in one paragraph

Anvika is a personal AI assistant you run on your own devices. It replies on the messaging surfaces you already use (WhatsApp, Telegram, Slack, Mattermost (plugin), Discord, Google Chat, Signal, iMessage, WebChat) and can also do voice + a live Canvas on supported platforms. The **Gateway** is the always-on control plane; the assistant is the product.

### What's the value proposition

Anvika is not "just a Claude wrapper." It's a **local-first control plane** that lets you run a
...
### What are the top five everyday use cases for Anvika
...
### Can Anvika help with lead gen outreach ads and blogs for a SaaS
...
Anvika draft and you approve.

Docs: [Security](/gateway/security).

### What are the advantages vs Claude Code for web development

Anvika is a **personal assistant** and coordination layer, not an IDE replacement. Use
Claude Code or Codex for the fastest direct coding loop inside a repo. Use Anvika when you
...
Showcase: [https://anvika.ai/showcase](https://anvika.ai/showcase)

## Skills and automation

### How do I customize skills without keeping the repo dirty

Use managed overrides instead of editing the repo copy. Put your changes in `~/.anvika/skills/<name>/SKILL.md` (or add a folder via `skills.load.extraDirs` in `~/.anvika/anvika.json`). Precedence is `<workspace>/skills` > `~/.anvika/skills` > bundled, so managed overrides win without touching git. Only upstream-worthy edits should live in the repo and go out as PRs.

### Can I load skills from a custom folder

Yes. Add extra directories via `skills.load.extraDirs` in `~/.anvika/anvika.json` (lowest precedence). Default precedence remains: `<workspace>/skills` → `~/.anvika/skills` → bundled → `skills.load.extraDirs`. `clawhub` installs into `./skills` by default, which Anvika treats as `<workspace>/skills`.
...
- Confirm cron is enabled (`cron.enabled`) and `ANVIKA_SKIP_CRON` is not set.
...
```bash
anvika cron run <jobId> --force
anvika cron runs --id <jobId> --limit 50
```
...
### Can Anvika run tasks on a schedule or continuously in the background
...
Not directly. macOS skills are gated by `metadata.anvika.os` plus required binaries, and skills only appear in the system prompt when they are eligible on the **Gateway host**. On Linux, `darwin`-only skills (like `apple-notes`, `apple-reminders`, `things-mac`) will not load unless you override the gating.

You have three supported patterns:

**Option A - run the Gateway on a Mac (simplest).**
Run the Gateway where the macOS binaries exist, then connect from Linux in [remote mode](#how-do-i-run-anvika-in-remote-mode-client-connects-to-a-gateway-elsewhere) or over Tailscale. The skills load normally because the Gateway host is macOS.

**Option B - use a macOS node (no SSH).**
Run the Gateway on Linux, pair a macOS node (menubar app), and set **Node Run Commands** to "Always Ask" or "Always Allow" on the Mac. Anvika can treat macOS-only skills as eligible when the required binaries exist on the node. The agent runs those skills via the `nodes` tool. If you choose "Always Ask", approving "Always Allow" in the prompt adds that command to the allowlist.
...
3. Override the skill metadata (workspace or `~/.anvika/skills`) to allow Linux:

   ```markdown
   ---
   name: apple-notes
   description: Manage Apple Notes via the memo CLI on macOS.
   metadata: { "anvika": { "os": ["darwin", "linux"], "requires": { "bins": ["memo"] } } }
   ---
   ```
...
ClawHub installs into `./skills` under your current directory (or falls back to your configured Anvika workspace); Anvika treats that as `<workspace>/skills` on the next session. For shared skills across agents, place them in `~/.anvika/skills/<name>/SKILL.md`. Some skills expect binaries installed via Homebrew; on Linux that means Linuxbrew (see the Homebrew Linux FAQ entry above). See [Skills](/tools/skills) and [ClawHub](/tools/clawhub).
...
- Persist `/home/node` with `ANVIKA_HOME_VOLUME` so caches survive.
- Bake system deps into the image with `ANVIKA_DOCKER_APT_PACKAGES`.
...
Anvika memory is just Markdown files in the agent workspace:

- Daily notes in `memory/YYYY-MM-DD.md`
- Curated long-term notes in `MEMORY.md` (main/private sessions only)

Anvika also runs a **silent pre-compaction memory flush** to remind the model
...
If you don't set a provider explicitly, Anvika auto-selects a provider when it
...
### Is all data used with Anvika saved locally

No - **Anvika's state is local**, but **external services still see what you send them**.

- **Local by default:** sessions, memory files, config, and workspace live on the Gateway host
  (`~/.anvika` + your workspace directory).
...
### Where does Anvika store its data

Everything lives under `$ANVIKA_STATE_DIR` (default: `~/.anvika`):

| Path                                                            | Purpose                                                            |
| --------------------------------------------------------------- | ------------------------------------------------------------------ |
| `$ANVIKA_STATE_DIR/anvika.json`                             | Main config (JSON5)                                                |
| `$ANVIKA_STATE_DIR/credentials/oauth.json`                    | Legacy OAuth import (copied into auth profiles on first use)       |
| `$ANVIKA_STATE_DIR/agents/<agentId>/agent/auth-profiles.json` | Auth profiles (OAuth, API keys, and optional `keyRef`/`tokenRef`)  |
| `$ANVIKA_STATE_DIR/secrets.json`                              | Optional file-backed secret payload for `file` SecretRef providers |
| `$ANVIKA_STATE_DIR/agents/<agentId>/agent/auth.json`          | Legacy compatibility file (static `api_key` entries scrubbed)      |
| `$ANVIKA_STATE_DIR/credentials/`                              | Provider state (e.g. `whatsapp/<accountId>/creds.json`)            |
| `$ANVIKA_STATE_DIR/agents/`                                   | Per-agent state (agentDir + sessions)                              |
| `$ANVIKA_STATE_DIR/agents/<agentId>/sessions/`                | Conversation history & state (per agent)                           |
| `$ANVIKA_STATE_DIR/agents/<agentId>/sessions/sessions.json`   | Session metadata (per agent)                                       |

Legacy single-agent path: `~/.anvika/agent/*` (migrated by `anvika doctor`).

Your **workspace** (AGENTS.md, memory files, skills, etc.) is separate and configured via `agents.defaults.workspace` (default: `~/.anvika/workspace`).

### Where should AGENTSmd SOULmd USERmd MEMORYmd live

These files live in the **agent workspace**, not `~/.anvika`.

- **Workspace (per agent)**: `AGENTS.md`, `SOUL.md`, `IDENTITY.md`, `USER.md`,
  `MEMORY.md` (or `memory.md`), `memory/YYYY-MM-DD.md`, optional `HEARTBEAT.md`.
- **State dir (`~/.anvika`)**: config, credentials, auth profiles, sessions, logs,
  and shared skills (`~/.anvika/skills`).

Default workspace is `~/.anvika/workspace`, configurable via:

```json5
{
  agents: { defaults: { workspace: "~/.anvika/workspace" } },
}
```
...
Do **not** commit anything under `~/.anvika` (credentials, sessions, tokens, or encrypted secrets payloads).
If you need a full restore, back up both the workspace and the state directory
separately (see the migration question above).

Docs: [Agent workspace](/concepts/agent-workspace).

### How do I completely uninstall Anvika
...
`workspace` to the repo root. The Anvika repo is just source code; keep the
...
Anvika reads an optional **JSON5** config from `$ANVIKA_CONFIG_PATH` (default: `~/.anvika/anvika.json`):

```
$ANVIKA_CONFIG_PATH
```

If the file is missing, it uses safe-ish defaults (including a default workspace of `~/.anvika/workspace`).

### I set gatewaybind lan or tailnet and now nothing listens the UI says unauthorized

Non-loopback binds **require auth**. Configure `gateway.auth.mode` + `gateway.auth.token` (or use `ANVIKA_GATEWAY_TOKEN`).
...
Anvika enforces token auth by default, including loopback. If no token is configured, gateway startup auto-generates one and saves it to `gateway.auth.token`, so **local WS clients must authenticate**. This blocks other local processes from calling the Gateway.

If you **really** want open loopback, set `gateway.auth.mode: "none"` explicitly in your config. Doctor can generate a token for you any time: `anvika doctor --generate-gateway-token`.
...
key. **Recommended:** run `anvika configure --section web` to store it in
...
- Daemons read env vars from `~/.anvika/.env` (or the service environment).
...
### Can the Anvika browser run headless
...
- Gateway is running: `anvika gateway status`
- Gateway health: `anvika status`
- Channel health: `anvika channels status`
...
### Can two Anvika instances talk to each other local VPS
...
`anvika agent --message ... --deliver`, targeting a chat where the other bot
...
```bash
anvika agent --message "Hello from local bot" --deliver --channel telegram --reply-to <chat-id>
```
...
- Restore from backup (git or a copied `~/.anvika/anvika.json`).
- If you have no backup, re-run `anvika doctor` and reconfigure channels/models.
- If this was unexpected, file a bug and include your last known config or any backup.
- A local coding agent can often reconstruct a working config from logs or history.

Avoid it:

- Use `anvika config set` for small changes.
- Use `anvika configure` for interactive edits.
...
```bash
anvika gateway --tailscale serve
```
...
### How does Anvika load environment variables

Anvika reads env vars from the parent process (shell, launchd/systemd, CI, etc.) and additionally loads:

- `.env` from the current working directory
- a global fallback `.env` from `~/.anvika/.env` (aka `$ANVIKA_STATE_DIR/.env`)
...
1. Put the missing keys in `~/.anvika/.env` so they're picked up even when the service doesn't inherit your shell env.
...
`ANVIKA_LOAD_SHELL_ENV=1`, `ANVIKA_SHELL_ENV_TIMEOUT_MS=15000`.

### I set COPILOTGITHUBTOKEN but models status shows Shell env off Why

`anvika models status` reports whether **shell env import** is enabled. "Shell env: off"
does **not** mean your env vars are missing - it just means Anvika won't load
your login shell automatically.

If the Gateway runs as a service (launchd/systemd), it won't inherit your shell
environment. Fix by doing one of these:

1. Put the token in `~/.anvika/.env`:
...
### Is there a way to make a team of Anvika instances one CEO and many agents
...
### How do I completely reset Anvika but keep it installed
...
```bash
anvika reset --scope full --yes --non-interactive
```
...
- If you used profiles (`--profile` / `ANVIKA_PROFILE`), reset each state dir (defaults are `~/.anvika-<profile>`).
- Dev reset: `anvika gateway --dev --reset` (dev-only; wipes dev config + credentials + sessions + workspace).
...
headers like `# Heading`), Anvika skips the heartbeat run to save API calls.
...
No. Anvika runs on **your own account**, so if you're in the group, Anvika can see it.
...
```bash
anvika directory groups list --channel whatsapp
```

Docs: [WhatsApp](/channels/whatsapp), [Directory](/cli/directory), [Logs](/cli/logs).

### Why doesn't Anvika reply in a group
...
- **Disk growth:** sessions + transcripts live under `~/.anvika/agents/<agentId>/sessions/`.
...
- Use `anvika doctor` to spot stray workspaces and profile mismatches.
...
Anvika's default model is whatever you set as:

```
agents.defaults.model.primary
```

Models are referenced as `provider/model` (example: `anthropic/claude-opus-4-6`). If you omit the provider, Anvika currently assumes `anthropic` as a temporary deprecation fallback - but you should still **explicitly** set `provider/model`.
...
- `anvika models set ...` (updates just model config)
- `anvika configure --section model` (interactive)
- edit `agents.defaults.model` in `~/.anvika/anvika.json`

Avoid `config.apply` with a partial object unless you intend to replace the whole config.
If you did overwrite config, restore from backup or re-run `anvika doctor` to repair.

Docs: [Models](/concepts/models), [Configure](/cli/configure), [Config](/cli/config), [Doctor](/gateway/doctor).

### What do Anvika, Flawd, and Krill use for models

- **Anvika + Flawd:** Anthropic Opus (`anthropic/claude-opus-4-6`) - see [Anthropic](/providers/anthropic).
...
Yes. Anvika ships a few default shorthands (only applied when the model exists in `agents.defaults.models`):
...
```
~/.anvika/agents/<agentId>/agent/auth-profiles.json
```

Fix options:

- Run `anvika agents add <id>` and configure auth during the wizard.
...
Cooldowns apply to failing profiles (exponential backoff), so Anvika can keep responding even when a provider is rate-limited or temporarily failing.
...
- **Confirm where auth profiles live** (new vs legacy paths)
  - Current: `~/.anvika/agents/<agentId>/agent/auth-profiles.json`
  - Legacy: `~/.anvika/agent/*` (migrated by `anvika doctor`)
- **Confirm your env var is loaded by the Gateway**
  - If you set `ANTHROPIC_API_KEY` in your shell but run the Gateway via systemd/launchd, it may not inherit it. Put it in `~/.anvika/.env` or enable `env.shellEnv`.
- **Make sure you're editing the correct agent**
  - Multi-agent setups mean there can be multiple `auth-profiles.json` files.
- **Sanity-check model/auth status**
  - Use `anvika models status` to see configured models and whether providers are authenticated.
...
- **Use a setup-token**
  - Run `claude setup-token`, then paste it with `anvika models auth setup-token --provider anthropic`.
  - If the token was created on another machine, use `anvika models auth paste-token --provider anthropic`.
- **If you want to use an API key instead**
  - Put `ANTHROPIC_API_KEY` in `~/.anvika/.env` on the **gateway host**.
  - Clear any pinned order that forces a missing profile:

    ```bash
    anvika models auth order clear --provider anthropic
    ```
...
If your model config includes Google Gemini as a fallback (or you switched to a Gemini shorthand), Anvika will try it during model fallback. If you haven't configured Google credentials, you'll see `No API key found for provider "google"`.
...
Fix: Anvika now strips unsigned thinking blocks for Google Antigravity Claude. If it still appears, start a **new session** or set `/thinking off` for that agent.
...
Anvika uses provider-prefixed IDs like:
...
Anvika may temporarily skip a profile if it's in a short **cooldown** (rate limits/timeouts/auth failures) or a longer **disabled** state (billing/insufficient credits). To inspect this, run `anvika models status --json` and check `auth.unusableProfiles`. Tuning: `auth.cooldowns.billingBackoffHours*`.

You can also set a **per-agent** order override (stored in that agent's `auth-profiles.json`) via the CLI:

```bash
# Defaults to the configured default agent (omit --agent)
anvika models auth order get --provider anthropic

# Lock rotation to a single profile (only try this one)
anvika models auth order set --provider anthropic anthropic:default

# Or set an explicit order (fallback within provider)
anvika models auth order set --provider anthropic anthropic:work anthropic:default
...
```bash
anvika models auth order set --provider anthropic --agent main anthropic:default
```

### OAuth vs API key what's the difference

Anvika supports both:
...
```
--port > ANVIKA_GATEWAY_PORT > gateway.port > default 18789
```

### Why does anvika gateway status say Runtime running but RPC probe failed

Because "running" is the **supervisor's** view (launchd/systemd/schtasks). The RPC probe is the CLI actually connecting to the gateway WebSocket and calling `status`.

Use `anvika gateway status` and trust these lines:

- `Probe target:` (the URL the probe actually used)
- `Listening:` (what's actually bound on the port)
- `Last gateway error:` (common root cause when the process is alive but the port isn't listening)

### Why does anvika gateway status show Config cli and Config service different

You're editing one config file while the service is running another (often a `--profile` / `ANVIKA_STATE_DIR` mismatch).

Fix:

```bash
anvika gateway install --force
```
...
Anvika enforces a runtime lock by binding the WebSocket listener immediately on startup (default `ws://127.0.0.1:18789`). If the bind fails with `EADDRINUSE`, it throws `GatewayLockError` indicating another instance is already listening.

Fix: stop the other instance, free the port, or run with `anvika gateway --port <port>`.

### How do I run Anvika in remote mode client connects to a Gateway elsewhere
...
- `anvika gateway` only starts when `gateway.mode` is `local` (or you pass the override flag).
...
- The Control UI stores the token in browser localStorage key `anvika.control.settings.v1`.

Fix:

- Fastest: `anvika dashboard` (prints + copies the dashboard URL, tries to open; shows SSH hint if headless).
- If you don't have a token yet: `anvika doctor --generate-gateway-token`.
- If remote, tunnel first: `ssh -N -L 18789:127.0.0.1:18789 user@host` then open `http://127.0.0.1:18789/`.
- Set `gateway.auth.token` (or `ANVIKA_GATEWAY_TOKEN`) on the gateway host.
- In the Control UI settings, paste the same token.
- Still stuck? Run `anvika status --all` and follow [Troubleshooting](/gateway/troubleshooting). See [Dashboard](/web/dashboard) for auth details.
...
- `ANVIKA_CONFIG_PATH` (per-instance config)
- `ANVIKA_STATE_DIR` (per-instance state)
- `agents.defaults.workspace` (workspace isolation)
- `gateway.port` (unique ports)

Quick setup (recommended):

- Use `anvika --profile <name> …` per instance (auto-creates `~/.anvika-<name>`).
- Set a unique `gateway.port` in each profile config (or pass `--port` for manual runs).
- Install a per-profile service: `anvika --profile <name> gateway install`.

Profiles also suffix service names (`ai.anvika.<profile>`; legacy `com.anvika.*`, `anvika-gateway-<profile>.service`, `Anvika Gateway (<profile>)`).
...
```
anvika tui --url ws://<host>:18789 --token <token>
```
...
```
/tmp/anvika/anvika-YYYY-MM-DD.log
```
...
- macOS: `$ANVIKA_STATE_DIR/logs/gateway.log` and `gateway.err.log` (default: `~/.anvika/logs/...`; profiles use `~/.anvika-<profile>/logs/...`)
- Linux: `journalctl --user -u anvika-gateway[-<profile>].service -n 200 --no-pager`
- Windows: `schtasks /Query /TN "Anvika Gateway (<profile>)" /V /FO LIST`
...
If you run the gateway manually, `anvika gateway --force` can reclaim the port. See [Gateway](/gateway).

### I closed my terminal on Windows how do I restart Anvika
...
1. Is the Gateway running? `anvika gateway status`
2. Is the Gateway healthy? `anvika status`
3. Does the UI have the right token? `anvika dashboard`
...
```bash
anvika channels status
anvika channels logs --channel telegram
```
...
### ELI5 anvika gateway restart vs anvika gateway

- `anvika gateway restart`: restarts the **background service** (launchd/systemd).
- `anvika gateway`: runs the gateway **in the foreground** for this terminal session.

If you installed the service, use the gateway commands. Use `anvika gateway` when
...
Outbound attachments from the agent must include a `MEDIA:<path-or-url>` line (on its own line). See [Anvika assistant setup](/start/anvika) and [Agent send](/tools/agent-send).

CLI sending:

```bash
anvika message send --target +15555550123 --message "Here you go" --media /path/to/file.png
```
...
### Is it safe to expose Anvika to inbound DMs

Treat inbound DMs as untrusted input. Defaults are designed to reduce risk:

- Default behavior on DM-capable channels is **pairing**:
  - Unknown senders receive a pairing code; the bot does not process their message.
  - Approve with: `anvika pairing approve --channel <channel> [--account <id>] <code>`
  - Pending requests are capped at **3 per channel**; check `anvika pairing list --channel <channel> [--account <id>]` if a code didn't arrive.
- Opening DMs publicly requires explicit opt-in (`dmPolicy: "open"` and allowlist `"*"`).

Run `anvika doctor` to surface risky DM policies.
...
No. Default WhatsApp DM policy is **pairing**. Unknown senders only get a pairing code and their message is **not processed**. Anvika only replies to chats it receives or to explicit sends you trigger.

Approve pairing with:

```bash
anvika pairing approve whatsapp <code>
```

List pending requests:

```bash
anvika pairing list whatsapp
```
...
Anvika blocks **cross-provider** messaging by default. If a tool call is bound
