...
- Install via CLI: `anvika plugins install @anvika/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `anvika plugins install ./extensions/zalo`
   - From npm (if published): `anvika plugins install @anvika/zalo`
...
- Approve via:
  - `anvika pairing list zalo`
  - `anvika pairing approve zalo <CODE>`
...
- Example: `anvika message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `anvika channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `anvika logs --follow`
