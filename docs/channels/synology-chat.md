---
summary: "Synology Chat webhook setup and Anvika config"
read_when:
  - Setting up Synology Chat with Anvika
...
```bash
anvika plugins install ./extensions/synology-chat
```
...
3. Point the outgoing webhook URL to your Anvika gateway:
   - `https://gateway-host/webhook/synology` by default.
   - Or your custom `channels.synology-chat.webhookPath`.
4. Configure `channels.synology-chat` in Anvika.
...
- Pairing approvals work with:
  - `anvika pairing list synology-chat`
  - `anvika pairing approve synology-chat <CODE>`
...
```bash
anvika message send --channel synology-chat --target 123456 --text "Hello from Anvika"
anvika message send --channel synology-chat --target synology-chat:123456 --text "Hello again"
```
