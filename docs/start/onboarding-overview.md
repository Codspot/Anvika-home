---
summary: "Overview of Anvika onboarding options and flows"
read_when:
...
Anvika supports multiple onboarding paths depending on where the Gateway runs
...
- [`anvika onboard` command](/cli/onboard)

## macOS app onboarding

Use the Anvika app when you want a fully guided setup on macOS. Docs:
