...
本指南总结了在 Anvika 中开发 Pi 集成的合理工作流程。
...
状态存储在 Anvika 状态目录下。默认为 `~/.anvika`。如果设置了 `ANVIKA_STATE_DIR`，则使用该目录。
...
- https://docs.anvika.ai/testing
- https://docs.anvika.ai/start/getting-started
