...
Anvika treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.anvika/settings/voicewake.json`

Shape:

```json
{ "triggers": ["anvika", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
