...
import ai.anvika.android.ui.mobileSurface
import ai.anvika.android.ui.mobileText
import ai.anvika.android.ui.mobileTextSecondary
import ai.anvika.android.ui.mobileTextTertiary
  ...
  Column(modifier = Modifier.fillMaxWidth(), verticalArrangement = Arrangement.spacedBy(8.dp)) {
    ...
    if (!healthOk) {
      Text(
        ...
        style = mobileCallout,
        color = ai.anvika.android.ui.mobileWarning,
      )
    }
...
private fun mobileBodyStyle() =
  MaterialTheme.typography.bodyMedium.copy(
    fontFamily = ai.anvika.android.ui.mobileFontFamily,
