...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: AnvikaPhotosLatestParams) async throws -> AnvikaPhotosLatestPayload {
        ...
        var results: [AnvikaPhotoPayload] = []
        ...
        return AnvikaPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> AnvikaPhotoPayload
    {
