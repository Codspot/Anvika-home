...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.anvika.gateway"
    private static let nodeService = "ai.anvika.node"
    private static let talkService = "ai.anvika.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.anvika.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.anvika.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .documentDirectory, in: .userDomainMask).first?
            .appendingPathComponent("anvika-gateway.log")
    }
