...
enum WatchMessagingError: LocalizedError {
    ...
    var errorDescription: String? {
        ...
        case .watchAppNotInstalled:
            "WATCH_UNAVAILABLE: Anvika watch companion app is not installed"
        }
    }
}

final class WatchMessagingService: NSObject, WatchMessagingServicing, @unchecked Sendable {
    private static let logger = Logger(subsystem: "ai.anvika", category: "watch.messaging")
        ...
        params: AnvikaWatchNotifyParams) async throws -> WatchNotificationSendResult
    {
        ...
        var payload: [String: Any] = [
            ...
            "title": params.title,
            "body": params.body,
            "priority": params.priority?.rawValue ?? AnvikaNotificationPriority.active.rawValue,
