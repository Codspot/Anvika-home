...
struct SettingsTab: View {
    ...
    @AppStorage("location.enabledMode") private var locationEnabledModeRaw: String = AnvikaLocationMode.off.rawValue
    ...
    @State private var lastLocationModeRaw: String = AnvikaLocationMode.off.rawValue
    ...
    private let gatewayLogger = Logger(subsystem: "ai.anvika.ios", category: "GatewaySettings")
    ...
    var body: some View {
        NavigationStack {
                ...
                Section("Device") {
                    DisclosureGroup("Features") {
                        ...
                        self.featureToggle(
                            ...
                            help: "Enables voice conversation mode with your connected Anvika agent.") { newValue in
                        ...
                        HStack(spacing: 8) {
                            ...
                            Button {
                                self.activeFeatureHelp = FeatureHelp(
                                    ...
                                    message: "Controls location permissions for Anvika. "
                        ...
                        Picker("Location Access", selection: self.$locationEnabledModeRaw) {
                            Text("Off").tag(AnvikaLocationMode.off.rawValue)
                            Text("While Using").tag(AnvikaLocationMode.whileUsing.rawValue)
                            Text("Always").tag(AnvikaLocationMode.always.rawValue)
                        }
                        .labelsHidden()
                        ...
                        self.featureToggle(
                            ...
                            help: "Keeps the screen awake while Anvika is open.")
                    ...
                    DisclosureGroup("Device Info") {
                        ...
                        LabeledContent("Anvika", value: DeviceInfoHelper.anvikaVersionString())
                    }
                }
            }
            ...
            .onChange(of: self.locationEnabledModeRaw) { _, newValue in
                ...
                guard let mode = AnvikaLocationMode(rawValue: newValue) else { return }
                Task {
