...
enum AnvikaConfigFile {
    private static let logger = Logger(subsystem: "ai.anvika", category: "config")
    ...
    static func stateDirURL() -> URL {
        AnvikaPaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        AnvikaPaths.workspaceURL
    }
    ...
    private static func appendConfigWriteAudit(_ fields: [String: Any]) {
        var record: [String: Any] = [
            ...
            "source": "macos-anvika-config-file",
            "event": "config.write",
