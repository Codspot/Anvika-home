...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/anvika/anvika") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/anvika/anvika")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://anvika.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "AnvikaBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "AnvikaBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "AnvikaGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "AnvikaGitCommit") as? String) ??
            "unknown"
    }
