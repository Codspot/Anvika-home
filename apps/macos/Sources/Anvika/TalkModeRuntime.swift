...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.anvika", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.anvika", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [AnvikaChatMessage] = messages.compactMap { item in
