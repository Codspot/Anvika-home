...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = AnvikaConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = AnvikaConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = AnvikaConfigFile.loadDict()
            ...
            AnvikaConfigFile.saveDict(root)
        }
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/anvika"
        state.remoteCliPath = ""
        return state
    }
}
