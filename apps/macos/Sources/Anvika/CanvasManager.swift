...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.anvika", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("Anvika/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__anvika__/a2ui/").absoluteString + "?platform=macos"
    }
