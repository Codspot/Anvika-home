...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .anvikaSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? AnvikaPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? AnvikaPaths.stateDirURL.path
...
extension Notification.Name {
    static let anvikaSelectSettingsTab = Notification.Name("anvikaSelectSettingsTab")
}
