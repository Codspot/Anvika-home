...
/// Menu contents for the Anvika menu bar extra.
struct MenuContent: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            self.debugMenu
            Button("About Anvika") { self.open(tab: .about) }
    ...
    private var connectionLabel: String {
        ...
        case .unconfigured:
            "Anvika Not Configured"
        case .remote:
            "Remote Anvika Active"
        case .local:
            "Anvika Active"
        }
    }
    ...
    private func open(tab: SettingsTab) {
        ...
        DispatchQueue.main.async {
            NotificationCenter.default.post(name: .anvikaSelectSettingsTab, object: tab)
        }
    }
