...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.anvika", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".anvika/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.anvikaCommand(
            subcommand: "gateway",
