...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.anvika", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return AnvikaConfigFile.defaultWorkspaceURL() }
