...
enum UIStrings {
    static let welcomeTitle = "Welcome to Anvika"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "anvika.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var onboardingChatModel: AnvikaChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g anvika@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: AnvikaChatViewModel(
