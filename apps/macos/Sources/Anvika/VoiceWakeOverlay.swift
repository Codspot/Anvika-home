...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.anvika", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other Anvika windows, but below the system’s pop-up menus.
