...
@MainActor
public struct AnvikaChatView: View {
    public enum Style {
        case standard
        case onboarding
    }

    @State private var viewModel: AnvikaChatViewModel
    ...
    private var visibleMessages: [AnvikaChatMessage] {
        let base: [AnvikaChatMessage]
    ...
    private func mergeToolResults(in messages: [AnvikaChatMessage]) -> [AnvikaChatMessage] {
    ...
    private func isToolResultMessage(_ message: AnvikaChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: AnvikaChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: AnvikaChatMessage) -> String {
