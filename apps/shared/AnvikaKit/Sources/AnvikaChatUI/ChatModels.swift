...
public typealias AnvikaPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias AnvikaPlatformImage = UIImage
#endif

public struct AnvikaChatUsageCost: Codable, Hashable, Sendable {
...
public struct AnvikaChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: AnvikaChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(AnvikaChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct AnvikaChatMessageContent: Codable, Hashable, Sendable {
...
public struct AnvikaChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [AnvikaChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: AnvikaChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [AnvikaChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: AnvikaChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(AnvikaChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([AnvikaChatMessageContent].self, forKey: .content) {
...
public struct AnvikaChatHistoryPayload: Codable, Sendable {
...
public struct AnvikaSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct AnvikaSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [AnvikaSessionPreviewItem]
}

public struct AnvikaSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [AnvikaSessionPreviewEntry]

    public init(ts: Int, previews: [AnvikaSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct AnvikaChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct AnvikaChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct AnvikaAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct AnvikaChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct AnvikaGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct AnvikaPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: AnvikaPlatformImage?
...
public struct AnvikaChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
