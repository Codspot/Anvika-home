...
public enum AnvikaTalkCommand: String, Codable, Sendable {
...
public struct AnvikaTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct AnvikaTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
