...
public enum AnvikaCanvasA2UICommand: String, Codable, Sendable {
...
public struct AnvikaCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct AnvikaCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
