...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.anvika", category: "node.gateway")
    ...
    static func invokeWithTimeout(
        ...
        let timeoutLogger = Logger(subsystem: "ai.anvika", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: AnvikaProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {
