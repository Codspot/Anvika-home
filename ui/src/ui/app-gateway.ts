...
export function connectGateway(host: GatewayHost) {
  ...
  const client = new GatewayBrowserClient({
    ...
    onHello: (hello) => {
      ...
      void loadAssistantIdentity(host as unknown as AnvikaApp);
      void loadAgents(host as unknown as AnvikaApp);
      void loadToolsCatalog(host as unknown as AnvikaApp);
      void loadNodes(host as unknown as AnvikaApp, { quiet: true });
      void loadDevices(host as unknown as AnvikaApp, { quiet: true });
...
function handleTerminalChatEvent(
  ...
  if (state === "final") {
    void loadSessions(host as unknown as AnvikaApp, {
...
function handleChatGatewayEvent(host: GatewayHost, payload: ChatEventPayload | undefined) {
  ...
  const state = handleChatEvent(host as unknown as AnvikaApp, payload);
  handleTerminalChatEvent(host, payload, state);
  if (state === "final" && shouldReloadHistoryForFinalEvent(payload)) {
    void loadChatHistory(host as unknown as AnvikaApp);
  }
}
