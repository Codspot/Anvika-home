...
function resetChatStateForSessionSwitch(state: AppViewState, sessionKey: string) {
  ...
  (state as unknown as AnvikaApp).chatStreamStartedAt = null;
  state.chatRunId = null;
  (state as unknown as AnvikaApp).resetToolStream();
  (state as unknown as AnvikaApp).resetChatScroll();
  state.applySettings({
    ...state.settings,
    sessionKey,
  ...
  return html`
    <div class="chat-controls">
      ...
      <button
        ...
        @click=${async () => {
          const app = state as unknown as AnvikaApp;
